                ...
                <div class="row">
                    <div class="col-lg-4 mb-md--40">
                        <div class="user-dashboard-tab__head nav flex-column" role="tablist" aria-orientation="vertical">
                            <a class="nav-link" data-toggle="pill" role="tab" href="#dashboard" aria-controls="dashboard" aria-selected="false">Tableau de bord</a>
                            <a class="nav-link active show" data-toggle="pill" role="tab" href="#orders" aria-controls="orders" aria-selected="true">Commandes</a>
                            <a class="nav-link" data-toggle="pill" role="tab" href="#downloads" aria-controls="downloads" aria-selected="false">Downloads</a>
                    ...
                    <div class="col-lg-8">
                        <div class="user-dashboard-tab__content tab-content">
                            <div class="tab-pane fade" id="dashboard">
                                <p>Hello <strong>hasan</strong> (not <strong>hasan</strong>? <a href="login.html">Log out</a>)</p>
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                           @foreach (Auth::user()->orders as $order)
                                            <tr>
                                                <td>#{{ $order->id }}</td>
                                                <td class="wide-column">Commande passé le {{ Carbon\Carbon::parse($order->payment_created_at)->format('d/m/Y à H:i') }}</td>
                                                {{-- <td>Processing</td> --}}
                                                <td class="wide-column">{{ getFomatterPrice($order->amount) }}
                                        ...
                                        <form action="#" class="form">
                                            ...
                                            <div class="form-row mb--20">
                                                <div class="form__group col-12">
                                                    ...
                                                    <select name="billing_country" id="billing_country" class="form__input form__input--3 nice-select" style="display: none;">
                                            ...
                                            <div class="form-row mb--20">
                                                <div class="form__group col-12">
                                                    ...
                                                    <select name="billing_district" id="billing_district" class="form__input form__input--3 nice-select" style="display: none;">
                                                    ...
                                                    </select><div class="nice-select form__input form__input--3" tabindex="0"><span class="current">Select a District…</span><div class="nice-select-search-box"><input type="text" class="nice-select-search" placeholder="Search..."></div><ul class="list"><li data-value="" class="option selected">Select a District…</li><li data-value="BARISAL" class="option">BARISAL</li><li data-value="BHOLA" class="option">BHOLA</li><li data-value="BANDARBAN" class="option">BANDARBAN</li><li data-value="BRAHMANBARIA" class="option">BRAHMANBARIA</li><li data-value="CHANDPUR" class="option">CHANDPUR</li><li data-value="CHITTAGONG" class="option">CHITTAGONG</li><li data-value="COMILLA" class="option">COMILLA</li><li data-value="COX'S BAZAR" class="option">COX'S BAZAR</li><li data-value="DHAKA" class="option">DHAKA</li><li data-value="FARIDPUR" class="option">FARIDPUR</li><li data-value="FENI" class="option">FENI</li><li data-value="GAZIPUR" class="option">GAZIPUR</li><li data-value="GOPALGANJ" class="option">GOPALGANJ</li><li data-value="JAMALPUR" class="option">JAMALPUR</li><li data-value="KHAGRACHHARI" class="option">KHAGRACHHARI</li><li data-value="KISHOREGONJ" class="option">KISHOREGONJ</li><li data-value="LAKSHMIPU" class="option">LAKSHMIPU</li><li data-value="RMADARIPUR" class="option">RMADARIPUR</li><li data-value="MUNSHIGANJ" class="option">MUNSHIGANJ</li><li data-value="MYMENSINGH" class="option">MYMENSINGH</li><li data-value="NARAYANGANJ" class="option">NARAYANGANJ</li><li data-value="NARSINGDI" class="option">NARSINGDI</li><li data-value="NETRAKONA" class="option">NETRAKONA</li><li data-value="NOAKHALI" class="option">NOAKHALI</li><li data-value="RANGAMATI" class="option">RANGAMATI </li><li data-value="RAJBARI" class="option">RAJBARI</li><li data-value="SHARIATPUR" class="option">SHARIATPUR</li><li data-value="SHERPUR" class="option">SHERPUR</li><li data-value="TANGAIL" class="option">TANGAIL</li></ul></div>
                                                </div>
                                            </div>
                                            <div class="form-row mb--20">
                                                <div class="form__group col-12">
                                        ...
                                        <form action="#" class="form">
                                            ...
                                            <div class="form-row mb--20">
                                                <div class="form__group col-12">
                                                    ...
                                                    <select id="shipping_country" name="shipping_country" class="form__input form__input--3 nice-select" style="display: none;">
                                                        <option value="">Select a country…</option>
                                                        <option value="AF">Afghanistan</option>
                                                        <option value="AL">Albania</option>
                                                        <option value="DZ">Algeria</option>
                                            ...
                                            <div class="form-row mb--20">
                                                <div class="form__group col-12">
                                                    ...
                                                    <select name="shipping_district" id="shipping_district" class="form__input form__input--3 nice-select" style="display: none;">
                                                        <option value="">Select a District…</option>
                                                        <option>BARISAL</option>
                                                        <option>BHOLA</option>
                                                        <option>BANDARBAN</option>
